(ns saml20-clj.xml
  (:require [saml20-clj.shared :as saml-shared]
...
(defn validate-xml-signature
  ...
  (let [sig-factory (xml-sig-factory)
        public-key (crypto/jcert->public-key (crypto/certificate-x509 cert-string))
